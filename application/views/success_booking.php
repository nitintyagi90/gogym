            ...
            <div class="col-md-3">
                <div class="dashboard-sidebar">
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link active" href="<?php echo base_url('Gogym/success_booking'); ?>" ><i class="ti-credit-card"></i>success Booking List</a>
                ...
                <div >
                    ...
                    <div class="tr-single-box">
                        ...
                        <div class="tr-single-header">
                            <h4><i class="ti-bell"></i>Success Booking Details</h4>
                        </div>
