        ...
        <div class="header light">
            <div class="container po-relative">
                <nav class="navbar navbar-expand-lg header-nav-bar">
                    <a href="JavaScript:Void(0);" class="navbar-brand"><img src="<?php echo base_url();?>web/assets/img/go-gyms-new .png" alt="GoGyms"></a>
                    ...
                    <div class="collapse navbar-collapse hover-dropdown font-14 ml-auto row" id="navigation">
