...
<script src="<?php echo base_url();?>admin/assets/plugins/carousel/owl.carousel.min.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/fullcalendar/vanillaCalendar.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/peity/jquery.peity.min.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/chartist/js/chartist.min.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/chartist/js/chartist-plugin-tooltip.min.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/metro/MetroJs.min.js"></script>
...
<script src="<?php echo base_url();?>admin/assets/plugins/clockpicker/jquery-clockpicker.min.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/colorpicker/jquery-asColor.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/colorpicker/jquery-asGradient.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/colorpicker/jquery-asColorPicker.min.js"></script>
<script src="<?php echo base_url();?>admin/assets/plugins/select2/select2.min.js"></script>
