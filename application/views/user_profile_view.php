                            ...
                            <div class="tr-single-body">
                                <div class="row">
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input readonly="true" class="form-control" type="text" name="user_name" value="<?php echo $profile_user[0]->user_name ?>">
                                        <input class="form-control" type="hidden" name="id" value="<?php echo $user[0]->id ?>">
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Gender</label>
                                        <select readonly="true" class="form-control" name="user_gender">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input readonly="true" class="form-control" type="email" name="user_email" value="<?php echo $profile_user[0]->user_email ?>">
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Mobile No</label>
                                        <input readonly="true" class="form-control" name="user_mobile" type="text" value="<?php echo $user[0]->mobile ?>">
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Password</label>
                                        <input readonly="true" class="form-control" name="user_password" type="password" value="<?php echo $user[0]->password ?>">
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Date Of Birth (DD/MM/YYYY)</label><br>
                                        <input readonly="true" type="date" name="user_dob" class="form-control" value="<?php echo $profile_user[0]->user_dob ?>">
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Location</label>
                                        <input readonly="true" type="text" value="<?php echo $profile_user[0]->user_location ?>" name="user_location" class="form-control" placeholder="Enter Location">
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input readonly="true" type="text" name="user_height_cm" value="<?php echo $profile_user[0]->user_height_cm ?>" id="cm" onkeyup="cmcalculate()" class="form-control" placeholder="Enter Height(In CM)">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input readonly="true" type="text" name="user_height_fit" value="<?php echo $profile_user[0]->user_height_fit ?>" id="fit" onkeyup="fitcalculate()" class="form-control" placeholder="Enter Height(In Fit)">

                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Weight</label>
                                        <input readonly="true" type="text" maxlength="3" onkeypress="javascript:return isNumber(event)" name="user_weight" value="<?php echo $profile_user[0]->user_weight ?>" class="form-control" placeholder="Enter Height(In Kg)" required>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Heart Rate</label>
                                        <input readonly="true" type="text" maxlength="3" onkeypress="javascript:return isNumber(event)" name="user_heart_rate" value="<?php echo $profile_user[0]->user_heart_rate ?>" class="form-control" placeholder="Enter Pulse" required>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Blood Pressure(Low)</label>
                                        <input readonly="true" type="text" maxlength="3" onkeypress="javascript:return isNumber(event)" name="user_bp_low" value="<?php echo $profile_user[0]->user_bp_low ?>" class="form-control" placeholder="Enter Blood Pressure(Low)" required>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Blood Pressure(High)</label>
                                        <input readonly="true" type="text" maxlength="3" onkeypress="javascript:return isNumber(event)" name="user_bp_high" value="<?php echo $profile_user[0]->user_bp_high ?>" class="form-control" placeholder="Enter Blood Pressure(High)" required>
                                    </div>
                                    <div class="form-group col-md-6 col-sm-12">
                                        <label>Smoking</label>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12" id="disease_details" style="display: none;">
                                        ...
                                        <textarea readonly="true" class="form-control"  rows="2" placeholder="Enter Disease Details" name="disease_details" required></textarea>
                                    </div>
                                    <div class="form-group col-md-12 col-sm-12">
                                        <label>Address</label>
                                        <textarea readonly="true" class="form-control" rows="2" placeholder="Enter Your Address" name="user_address" required><?php echo $profile_user[0]->user_address ?></textarea>
                                    </div>

                                    <div class="form-group col-md-12 col-sm-12">
                                        <label>Profile Image</label>
                                        <div class="custom-file">
                                            <input readonly="true" type="file" class="form-control" name="user_images" accept="image/x-png,image/gif,image/jpeg" />
